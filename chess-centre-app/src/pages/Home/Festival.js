...
const stats = [
  { label: 'Open', value: '15' },
  { label: 'Major', value: '34' },
  { label: 'Intermediate', value: '27' },
  { label: 'Minor', value: '3' },
]
const logos = [
      ...
      <main>
            ...
            <div>
              <div>
                <img
                  ...
                  alt="Workflow"
                />
                <i className="fa fa-chess-centre"></i>
              </div>
              <div className="mt-20">
                <div>
                  <a href="#" className="inline-flex space-x-4">
                    <span className="rounded bg-teal-50 px-2.5 py-1 text-xs font-semibold text-teal-500 tracking-wide uppercase">
                      What's new
                    </span>
                    <span className="inline-flex items-center text-sm font-medium text-teal-500 space-x-1">
                ...
                <form action="#" className="mt-12 sm:max-w-lg sm:w-full sm:flex">
                  <div className="min-w-0 flex-1">
                    ...
                    <input
                      id="hero-email"
                      type="email"
                      className="block w-full border border-gray-300 rounded-md px-5 py-3 text-base text-gray-900 placeholder-gray-500 shadow-sm focus:border-teal-500 focus:ring-teal-500"
                  ...
                  <div className="mt-4 sm:mt-0 sm:ml-3">
                    <button
                      type="submit"
                      className="block w-full rounded-md border border-transparent px-5 py-3 bg-teal-500 text-base font-medium text-white shadow hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 sm:px-10"
                    >
                      Notify me
                    </button>
                  </div>
                ...
                <div className="mt-6">
                  <div className="inline-flex items-center divide-x divide-gray-300">
                    ...
                    <div className="min-w-0 flex-1 pl-5 py-1 text-sm text-gray-500 sm:py-3">
                      ...
                      <span className="font-medium text-teal-500">500 beta users</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
              ...
              <div className="relative pl-4 -mr-40 sm:mx-auto sm:max-w-3xl sm:px-0 lg:max-w-none lg:h-full lg:pl-12">
                <img
                  ...
                  src="https://tailwindui.com/img/component-images/task-app-teal.jpg"
                  alt=""
                />
              </div>
            </div>
              ...
              <div className="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0 lg:max-w-none lg:py-20">
                ...
                <div className="relative pt-64 pb-10 rounded-2xl shadow-xl overflow-hidden">
                  <img
                    ...
                    src="https://www.bradford-theatres.co.uk/assets/images/kingshall/kh2.jpg"
                    alt=""
                  />
                  <div className="absolute inset-0 bg-teal-500 mix-blend-multiply" />
                  <div className="absolute inset-0 bg-gradient-to-t from-teal-600 via-teal-600 opacity-80" />
                  <div className="relative px-8">
                    ...
                    <blockquote className="mt-8">
                      ...
                      <footer className="mt-4">
                        <p className="text-base font-semibold text-teal-200">Sarah Williams, CEO at Workcation</p>
                      </footer>
                    </blockquote>
                  </div>
                </div>
        ...
        <div className="relative mt-24 sm:mt-32 sm:py-16">
          ...
          <div className="mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="relative rounded-2xl px-6 py-10 bg-teal-500 overflow-hidden shadow-xl sm:px-12 sm:py-20">
                ...
                <form action="#" className="mt-12 sm:mx-auto sm:max-w-lg sm:flex">
                  <div className="min-w-0 flex-1">
                    ...
                    <input
                      id="cta-email"
                      type="email"
                      className="block w-full border border-transparent rounded-md px-5 py-3 text-base text-gray-900 placeholder-gray-500 shadow-sm focus:outline-none focus:border-transparent focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-teal-500"
                      placeholder="Enter your email"
                    />
                  </div>
                  <div className="mt-4 sm:mt-0 sm:ml-3">
                    <button
                      type="submit"
                      className="block w-full rounded-md border border-transparent px-5 py-3 bg-gray-900 text-base font-medium text-white shadow hover:bg-black focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-teal-500 sm:px-10"
                    >
                      Notify me
                    </button>
                  </div>
